...
export default function WeChatSimulator({
  ...
  const [wechatAvatar, setWechatAvatar] = useState<string>("parent");
          ...
          <div className="flex-1 overflow-y-auto wechat-screen-scrollbar flex flex-col bg-zinc-50 relative">
            ...
            {page === "welcome" && (
              <div className="flex-1 flex flex-col justify-between p-6 text-center select-none bg-white relative">
                <div className="my-auto space-y-5">
                  ...
                  <div>
                    <h1 className="text-xl font-bold text-zinc-900">耳畔童话</h1>
                  ...
                  <div className="bg-zinc-50 p-4 rounded-2xl border border-zinc-200/60 text-left text-xs text-zinc-600 space-y-2">
                    <p><Icon name="sparkles" size={14} className="inline-block align-text-bottom mr-0.5" /> <b>AI个性化绘本</b>：为孩子定制专属教育主题与故事场景</p>
                    <p><Icon name="mic" size={14} className="inline-block align-text-bottom mr-0.5" /> <b>亲子声音克隆</b>：仅录音30秒，即刻合成爸爸妈妈温暖的声音</p>
                    <p><Icon name="moon" size={14} className="inline-block align-text-bottom mr-0.5" /> <b>星夜陪伴播放</b>：独家星空播放器，沉浸伴眠体验</p>
                  </div>
                </div>
                <div className="space-y-3">
                  ...
                  >
                    <MessageSquare className="w-4 h-4" /> 微信一键快速登录
                  </button>
                  <p className="text-[9px] text-zinc-400">登录即代表您已同意《耳畔童话用户协议》和《儿童信息保护政策》</p>
                </div>
                ...
                {showWeChatAuth && (
                  <div className="absolute inset-0 bg-black/60 z-50 flex flex-col justify-end text-left">
                    ...
                    {/* WeChat Bottom Sheet */}
                    <div className="bg-white max-h-[86%] overflow-y-auto rounded-t-3xl p-5 space-y-4 shadow-xl border-t border-zinc-150">
                      ...
                      <div className="space-y-3">
                        <div className="space-y-1">
                          <h4 className="text-xs font-extrabold text-zinc-900">耳畔童话 申请使用：</h4>
                          <p className="text-[10px] text-zinc-500">您选择的昵称和头像样式将用于个性化家长称呼及同步绘本记录</p>
                        </div>
                        ...
                        <div className="bg-zinc-50 p-3.5 rounded-2xl border border-zinc-150 space-y-3">
                          ...
                          <div className="flex items-center justify-between">
                            <span className="text-xs text-zinc-600 font-medium">选择头像样式</span>
                            <div className="flex gap-1.5">
                              {WECHAT_AVATAR_OPTIONS.map(option => (
                                <button
                                  key={option.id}
                                  type="button"
                                  onClick={() => setWechatAvatar(option.id)}
                                  className={`w-7 h-7 rounded-full flex items-center justify-center text-sm transition-all border ${
                                    wechatAvatar === option.id ? 'bg-zinc-900 border-zinc-950 scale-110 shadow-xs' : 'bg-white border-zinc-200 hover:bg-zinc-100'
                                  }`}
                                >
                                  <Icon name={option.icon} size={16} color={wechatAvatar === option.id ? "#ffffff" : option.color} />
                                </button>
                              ))}
                            </div>
                          </div>
                      ...
                      <p className="text-[8px] text-center text-zinc-400">授权登录即代表您已同意《耳畔童话用户协议》</p>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="p-4 space-y-4 flex-1">
                  ...
                  <div className="bg-zinc-100 p-3 rounded-2xl border border-zinc-200/50 flex items-center justify-between">
                    <div className="flex items-center gap-2.5 overflow-hidden">
                      ...
                      <div className="overflow-hidden">
                        <span className="text-[10px] text-zinc-500 font-bold block">最近播放 <Icon name="volume" size={12} className="inline-block align-text-bottom" /></span>
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-xs font-bold text-zinc-900 flex items-center gap-1"><Icon name="sparkles" size={14} /> 耳畔推荐绘本模板</span>
                    <button 
            ...
            {page === "tab_studio" && (
              <div className="p-4 space-y-4 flex-1">
                <div className="bg-zinc-100 p-4 rounded-2xl border border-zinc-200/60 space-y-2">
                  <span className="text-xs font-bold text-zinc-900 flex items-center gap-1"><Icon name="mic" size={14} /> 声音克隆系统说明</span>
                  <p className="text-[10px] text-zinc-500 leading-relaxed">
                    耳畔有声克隆基于业内顶尖的深度合成模型，仅需录制一段约<b>30秒</b>的故事散句，即可完美还原家庭成员独一无二的音色、情感和讲故事的节奏，给孩子最本真的睡前陪伴。
                  </p>
                ...
                <div className="bg-white p-4 rounded-3xl border border-zinc-200/80 shadow-xs space-y-4">
                  <span className="text-xs font-bold text-zinc-900 flex items-center gap-1">创建新的家庭声音 <Icon name="headphones" size={14} /></span>
            ...
            {page === "tab_my" && (
              <div className="p-4 space-y-4 flex-1">
                ...
                <div className="bg-white p-4 rounded-3xl border border-zinc-200/80 shadow-xs space-y-3">
                  <span className="text-xs font-bold text-zinc-900 flex items-center gap-1"><Icon name="gift" size={14} /> 绑定好友邀请码</span>
                ...
                <div className="bg-white rounded-3xl border border-zinc-200/80 shadow-xs overflow-hidden text-xs">
                  ...
                  <button 
                    onClick={() => {
                      alert("耳畔童话微信小程序原型 MVP 版 v1.1.0\n基于 StepFun（阶跃星辰）大模型与声音克隆的个性化有声绘本陪伴应用。");
                    }}
                    className="w-full text-left p-3.5 hover:bg-zinc-50 border-b border-zinc-100 flex justify-between items-center text-zinc-900 transition-colors"
                  >
                    <span className="flex items-center gap-1"><Icon name="info" size={14} /> 关于耳畔童话</span>
                    <ChevronRight className="w-4 h-4 text-zinc-400" />
                  </button>
                  <button 
                    onClick={() => {
                ...
                <div className="flex-1 py-4 flex flex-col justify-start">
                  ...
                  {wizardStep === 1 && (
                    <div className="space-y-4">
                      ...
                      >
                        <span className="text-xs font-bold text-zinc-900 flex items-center gap-1"><Icon name="edit" size={14} /> 自定义新创作</span>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          >
                            <span className="flex items-center gap-1"><Icon name="edit" size={12} /> 自定义主题</span>
                          </button>
                        </div>
                      </div>
                      ...
                      {wizardTheme !== "自定义" && (
                        <div>
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            >
                              <span className="flex items-center gap-1"><Icon name="edit" size={12} /> 自定义教育目标...</span>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          >
                            <span className="flex items-center gap-1"><Icon name="edit" size={12} /> 自定义场景</span>
                          </button>
                        </div>
                        {wizardScene === "自定义" && (
                          <div className="mt-2.5 p-3 bg-orange-50/40 rounded-2xl border border-orange-100">
                            ...
                            <div key={char.id} className="relative p-3.5 bg-white rounded-2xl border border-zinc-200 space-y-3 shadow-3xs">
                              ...
                              <div className="flex justify-between items-center border-b border-zinc-100 pb-2">
                                <span className="text-[11px] font-extrabold text-zinc-950 flex items-center gap-1.5">
                                  <Icon name="user" size={12} /> 主人公 #{index + 1}
                                ...
                                <div className="flex items-center gap-1.5">
                                  ...
                                  >
                                    <span className="flex items-center gap-0.5"><Icon name="edit" size={10} /> {char.isCustomDescription ? '切换常规' : '完全自定义描述'}</span>
                                  </button>
                  ...
                  {wizardStep === 4 && (
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <label className="flex items-center gap-1 text-xs font-bold text-zinc-900">2. 选择讲故事配音 <Icon name="volume" size={14} /></label>
                        ...
                        <div className="flex flex-col gap-2 max-h-[160px] overflow-y-auto pr-1">
                          {db?.voiceClones && db.voiceClones.length > 0 ? (
                            ...
                            <div className="text-center py-4 bg-zinc-50 rounded-2xl border border-zinc-200/60 p-3">
                              ...
                              >
                                <span className="flex items-center gap-1">立即去录制克隆 <Icon name="mic" size={12} /></span>
                              </button>
                            </div>
                          )}
                        </div>
                      ...
                      <div>
                        <label className="flex items-center gap-1 text-xs font-bold text-zinc-900 mb-1">4. 耳畔背景音 (白噪音) <Icon name="moon" size={14} /></label>
                        <select 
                          value={wizardBgmType} 
                  ...
                  {wizardStep === 5 && (
                    <div className="space-y-4">
                      ...
                      <div className="bg-white p-4 rounded-3xl border border-zinc-200/80 shadow-xs space-y-2.5 text-xs text-zinc-900">
                        ...
                        <div className="flex justify-between border-b border-zinc-100 pb-1.5">
                          <span className="text-zinc-400">耳畔背景音 (白噪音)</span>
                          <span className="font-bold">
              ...
              <div className="flex-1 flex flex-col justify-center items-center p-6 text-center space-y-6 bg-zinc-50/50">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[10px] text-zinc-500 leading-normal max-w-[240px]">
                    StepFun（阶跃星辰）正在根据您的定制需求：【主题：{wizardTheme}，主角：{charName || "宝宝"}】精心组织大纲和每一章节。
                  </p>
                </div>
                ...
                <div className="w-full bg-amber-50/50 border border-amber-100/50 p-4 rounded-2xl text-left text-[10px] text-amber-800 space-y-2 shadow-xs">
                  <p className="font-extrabold flex items-center gap-1.5 text-amber-950">
                    <span className="animate-pulse text-amber-500">✨</span> 耳畔星夜精灵童话编织预测：
                  </p>
            ...
            {page === "text_preview" && generatedTextStory && (
              <div className="p-4 space-y-4 flex-1 flex flex-col justify-between bg-zinc-50/10">
                ...
                <div className="space-y-4 flex-1">
                  ...
                  <div className="space-y-3">
                    <span className="text-xs font-bold text-zinc-900 flex items-center gap-1"><Icon name="book-open" size={14} /> 绘本章节内容预览 ({generatedTextStory.chapters?.length}章)</span>
                ...
                <div className="pt-4 shrink-0 border-t border-zinc-200/80 space-y-2">
                  <div className="flex gap-2">
                    ...
                    >
                      <span className="flex items-center gap-1"><Icon name="refresh" size={12} /> 重新生成 ({retryCount === 0 ? "免费1次" : "扣1次"})</span>
                    </button>
                    ...
                    <button 
                      ...
                      className="flex-1 bg-zinc-950 hover:bg-zinc-900 text-white text-xs py-2.5 rounded-xl font-bold shadow-sm transition flex items-center justify-center gap-1"
                    >
                      <span className="flex items-center gap-1">满意，合成有声故事 <Icon name="volume" size={12} /></span>
                    </button>
                  </div>
              ...
              <div className="flex-1 flex flex-col justify-between p-5 bg-zinc-50 overflow-y-auto wechat-screen-scrollbar">
                <div className="flex-1 flex flex-col justify-center items-center p-2 text-center space-y-5">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-zinc-500 leading-normal max-w-[240px]">
                      耳畔童话正在将克隆声线：【{db?.voiceClones?.find((v: any) => v.id === wizardVoiceId)?.name || "妈妈的温柔声"}】完美与 AI 童话融合！
                    </p>
                  </div>
                ...
                <div className="pt-4 shrink-0 space-y-3.5">
                  ...
                  <div className="bg-zinc-100/80 p-2 rounded-2xl border border-zinc-200/50 space-y-1.5 text-left">
                    <div className="flex justify-between items-center text-[9px] font-bold text-zinc-500 px-1">
                      <span className="flex items-center gap-1"><Icon name="moon" size={14} /> 耳畔白噪音：<b>{activeBgmType === 'none' ? '关闭' : activeBgmType === 'soft_noise' ? '柔和白噪音' : activeBgmType === 'rain' ? '窗外雨声' : activeBgmType === 'waves' ? '海浪拍沙' : '松林微风'}</b></span>
                ...
                <div className="flex-1 overflow-y-auto space-y-3 pr-1 wechat-screen-scrollbar">
                  {filteredStories.length === 0 ? (
                    <div className="text-center py-12 space-y-2 select-none">
                      <Icon name="book-open" size={36} className="text-zinc-300" />
            ...
            {showNotifications && (
              ...
              >
                ...
                <div className="p-4 border-b border-zinc-200/80 flex justify-between items-center shrink-0">
                  <span className="text-xs font-bold text-zinc-900 flex items-center gap-1"><Icon name="bell" size={14} /> 通知消息中心</span>
                  <div className="flex gap-2">
                    <button 
                      onClick={() => {
              ...
              >
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <span className="flex items-center justify-center gap-1"><Icon name="sparkles" size={14} /> 耳畔温馨安全改写建议</span>
                    </h3>
